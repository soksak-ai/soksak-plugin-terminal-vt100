...
requireText("node-version-file: soksak-plugins/soksak-plugin-terminal-vt100/.node-version", "Node owner");
requireText("package_json_file: soksak-plugins/soksak-plugin-terminal-vt100/frontend/package.json", "pnpm owner");
